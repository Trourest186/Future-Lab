...
MASTER_USERNAME = "master.kn"  # Khong dung
MASTER_PASSWORD = "1"
PROM_IP = "172.16.10.150"
# MEC_IP = "172.16.42.12"
...
BASH_PATH = DEFAULT_DIRECTORY + "/deployments" # Giang fix
...
# CMD
# docker.io/kiemtcb/detection-object:4.7arm@sha256:6b8bd5ddc833054c49f48ce3ae8981bfedb207567fc26033ba4e8ceba796a11c
...
CURL_TRIGGER_TIME = "curl -w \"@curl-time.txt\"  " + HEAVY_DNS + "/api/active" # Đã thử
CURL_RESPONSE_TIME = "curl -F upload=@{}.jpg -w \"@curl-time.txt\"  " + HEAVY_DNS + "/api/picture" # Cần tìm ảnh để up load
CURL_FPS = "curl http://detection{}.serverless.svc.cluster.local/download -o file{}.log" # Đã thử
